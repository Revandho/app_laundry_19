                                ...
                                <div class="modal-body">
                                  <form method="post" action="update_transaksi.php">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label>Diskon</label>
                                        <input type="text" name="diskon" value="<?php echo $d_tb_transaksi['diskon']; ?>" class="form-control" placeholder="Masukan Jumlah Diskon">
                                      </div>
                                      <div class="form-group">
                                        <label>Pajak</label>
                                        <input type="text" name="pajak" value="<?php echo $d_tb_transaksi['pajak']; ?>" class="form-control" placeholder="Masukan Jumlah Pajak">
                                      </div>
                                      <div class="form-group">
                                        <?php
                                        include "../koneksi.php";
