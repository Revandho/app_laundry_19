        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header" style="background-color:peachpuff">
              <h3 class="card-title"><b>Data Paket</b></h3>
                    ...
                    while($d_tb_paket = mysqli_fetch_array($tb_paket)){
                      ...
                      while($d_tb_outlet_d = mysqli_fetch_array($tb_outlet_d)){
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit<?php echo $d_tb_paket['id']; ?>"><i class="fas fa-edit"></i> Ubah</button>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header" style="background-color:red">
                                <h4 class="modal-title"><b>Hapus Data Paket</b></h4>
