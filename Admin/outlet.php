        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header" style="background-color:peachpuff">
              <h3 class="card-title"><b>Data Outlet</b></h3>
                  ...
                  <tbody>
                    ...
                    while($d_tb_outlet = mysqli_fetch_array($tb_outlet)){
                      ...
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-edit<?php echo $d_tb_outlet['id']; ?>"><i class="fas fa-edit"></i> Ubah</button>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header" style="background-color:red">
                              <h4 class="modal-title"><b>Hapus Data Outlet</b></h4>
                            ...
                            <form method="post" action="update_outlet.php">
                              <div class="modal-body">                          
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="tlp" onkeypress="return hanyaAngka(event)"value="<?php echo $d_tb_outlet['tlp']; ?>" class="form-control" placeholder="Masukan No Telephone">
                                  <script>
